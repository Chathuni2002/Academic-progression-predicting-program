...
while command == 'y' :            
    ...
    data_list = [tuple(in_list[x:x+3]) for x in range(0, len(in_list), 3)]  # https://stackoverflow.com/questions/9671224/split-a-python-list-into-other-sublists-i-e-smaller-lists#:~:text=You%20could%20use%20numpy%27s%20array_split,20%20nearly%20equal%20size%20chunks.
